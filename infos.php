...
<head>
	<!-- ## SITE META ## -->
	<meta charset="utf-8">
	<title>INHAITI | Chaîne de prières | Les temps de prière</title>
...
<header id="qcHeader">
	<div class="row">
		...
		<nav id="qcPriNav" class="col-6 col">
			<ul class="clearfix">
				<li class="current"><a href="infos.php"><i class="icon-calendar-2 icon"></i> <span>+ D'INFOS</span></a></li>
										...
										<ul id="qcTestimonialList" class="clearfix">
											<li>
												<a href="#" class="active" data-content="Lorem ipsum dolor sit amet, consectetur adipisicing elit." data-cite="John Doe via Twitter">
													<img src="../../../pbs.twimg.com/profile_images/500480798886084611/P5XUPlTJ.jpg" alt="" />
												</a>
											</li>
											<li>
												<a href="#" data-content="quibusdam est porro illum adipisci minima cupiditate sequi velit eaque enim sed nihil excepturi repellendus eum error vero!" data-cite="Samantha via Twitter">
													<img src="../../../pbs.twimg.com/profile_images/499941427820769281/8tYwgR5r.png" alt="" />
												</a>
											</li>
											<li>
												<a href="#" data-content="Lorem ipsum dolor sit amet, consectetur adipisicing elit." data-cite="John Doen via Twitter">
													<img src="../../../pbs.twimg.com/profile_images/2823681988/f4f6f2bed8ab4d5a48dea4b9ea85d5f1.jpg" alt="" />
												</a>
											</li>
											<li>
												<a href="#" data-content="quibusdam est porro illum adipisci minima cupiditate sequi velit eaque enim sed nihil excepturi repellendus eum error vero!" data-cite="Samantha via Twitter">
													<img src="../../../pbs.twimg.com/profile_images/462307615536472065/WKDR6Tja.jpg" alt="" />
												</a>
											</li>
											<li>
												<a href="#" data-content="Lorem ipsum dolor sit amet, consectetur adipisicing elit." data-cite="John Doe via Twitter">
													<img src="../../../pbs.twimg.com/profile_images/512033905503772672/kYJ10GzB.jpg" alt="" />
												</a>
											</li>
											<li>
												<a href="#" data-content="quibusdam est porro illum adipisci minima cupiditate sequi velit eaque enim sed nihil excepturi repellendus eum error vero!" data-cite="Samantha via Twitter">
													<img src="../../../pbs.twimg.com/profile_images/470664455647272960/u0PDyeFr.jpg" alt="" />
												</a>
											</li>
											<li>
												<a href="#" data-content="Lorem ipsum dolor sit amet, consectetur adipisicing elit." data-cite="John Doe via Twitter">
													<img src="../../../pbs.twimg.com/profile_images/470898770268282880/VJ0DghGr.jpg" alt="" />
												</a>
											</li>
											<li>
												<a href="#" data-content="quibusdam est porro illum adipisci minima cupiditate sequi velit eaque enim sed nihil excepturi repellendus eum error vero!" data-cite="Samantha via Twitter">
													<img src="../../../pbs.twimg.com/profile_images/513432886226075648/ZViDgotW.jpg" alt="" />
												</a>
											</li>
											<li>
												<a href="#" data-content="Lorem ipsum dolor sit amet, consectetur adipisicing elit." data-cite="John Doe via Twitter">
													<img src="../../../pbs.twimg.com/profile_images/477437377321791488/0WEJuCyc.png" alt="" />
												</a>
											</li>
											<li>
												<a href="#" data-content="quibusdam est porro illum adipisci minima cupiditate sequi velit eaque enim sed nihil excepturi repellendus eum error vero!" data-cite="Samantha via Twitter">
													<img src="../../../pbs.twimg.com/profile_images/378800000764200227/06fdbd84de5e6bba08a2ff81e7fa56b0.jpg" alt="" />
												</a>
											</li>
										</ul>
						...
						<div class="row clearfix">
							<div class="col-12 col">
								...
								<ul class="qcSposnsorList clearfix">
									<li>
										<a href="#" class="tips" title="INTRODUCTION">
											<img src="../agencia/assets/img/placeholder/partner-1.png" alt="" />
										</a>
									</li>
									<li>
										<a href="#" class="tips" title="INTRODUCTION">
											<img src="../agencia/assets/img/placeholder/partner-2.png" alt="" />
										</a>
									</li>
									<li>
										<a href="#" class="tips" title="INTRODUCTION">
											<img src="../agencia/assets/img/placeholder/partner-3.png" alt="" />
										</a>
									</li>
									<li>
										<a href="#" class="tips" title="INTRODUCTION">
											<img src="../agencia/assets/img/placeholder/partner-4.png" alt="" />
										</a>
									</li>
									<li>
										<a href="#" class="tips" title="INTRODUCTION">
											<img src="../agencia/assets/img/placeholder/partner-5.png" alt="" />
										</a>
									</li>
									<li>
										<a href="#" class="tips" title="INTRODUCTION">
											<img src="../agencia/assets/img/placeholder/partner-6.html" alt="" />
										</a>
									</li>
									<li>
										<a href="#" class="tips" title="INTRODUCTION">
						...
						<div class="row clearfix">
							<div class="col-12 col">
								...
								<div class="qcEventlayout">
									<h1>Layout Plan</h1>
									<a href="assets/img/placeholder/layout.jpg" data-rel="prettyPhoto[pp_gal]">
										<img src="assets/img/placeholder/layout.jpg" alt="" />
									</a>
								</div>
						...
						<div class="col-8 col">
							<div class="video box no-border">
								<ul id="imgGallery" class="clearfix">
									...
									<li>
										<a href="http://themeforest.quadcodes.com/wordpress/musicvent/gallery/ultramusic-festival/" class="tips video" title="UltraMusic Festival" data-rel="prettyPhoto[pp_gal]">
											<img src="../../wordpress/musicvent/wp-content/uploads/2014/03/ultraba14a_023.jpg" alt="UltraMusic Festival"/>
										</a>
									</li>
									<li>
										<a href="http://themeforest.quadcodes.com/wordpress/musicvent/gallery/zedd/" class="tips video" title="Zedd" data-rel="prettyPhoto[pp_gal]">
											<img src="../../wordpress/musicvent/wp-content/uploads/2014/03/ultrasa14b_155.jpg" alt="Zedd"/>
										</a>
									</li>
									<li>
										<a href="http://themeforest.quadcodes.com/wordpress/musicvent/gallery/bassnectar/" class="tips" title="Bassnectar" data-rel="prettyPhoto[pp_gal]">
											<img src="../../wordpress/musicvent/wp-content/uploads/2014/03/ultraba14a_129.jpg" alt="Bassnectar"/>
										</a>
									</li>
									<li>
										<a href="http://themeforest.quadcodes.com/wordpress/musicvent/gallery/stereosonic/" class="tips" title="Stereosonic" data-rel="prettyPhoto[pp_gal]">
											<img src="../../wordpress/musicvent/wp-content/uploads/2014/03/ultrasa14b_138.jpg" alt="Stereosonic"/>
										</a>
									</li>
									<li>
										<a href="http://themeforest.quadcodes.com/wordpress/musicvent/gallery/omfg/" class="tips" title="OMFG!" data-rel="prettyPhoto[pp_gal]">
											<img src="../../wordpress/musicvent/wp-content/uploads/2014/03/ultrasa14b_072.jpg" alt="OMFG!"/>
										</a>
									</li>
									<li>
										<a href="http://themeforest.quadcodes.com/wordpress/musicvent/gallery/excision/" class="tips" title="Excision" data-rel="prettyPhoto[pp_gal]">
											<img src="../../wordpress/musicvent/wp-content/uploads/2014/03/ultraba14a_008.jpg" alt="Excision"/>
										</a>
									</li>
								</ul>
...
<!-- Mirrored from themeforest.quadcodes.com/site/eventicka/event.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 01 Sep 2017 08:41:11 GMT -->
</html>